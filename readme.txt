GDK3 SDK Package based on GNU Tools for ARM Embedded Processors v4.7+
...
samples/startup   - Startup code needed by samples
       ...
       /inc       - header files for GDK3
       /debug     - .c code for debug
       /driver    - .c code to access peripherals  
...
** gem3 - ge(means study)/explore Cortex-M3 core via GDK3
This is the first sample with basic hardware support. It demonstrates steps
to initialize clock and other components in CH32 SoC. Also it setups gpio of 
GDK3 and make a simple hello world app in IoT style.
