...
typedef enum {NoREADY = 0, READY = !NoREADY} ReaderStatus; // ErrorStatus; //copied from older version 2022-12-04
...
typedef struct
{
  ...
  __IO uint32_t BRR;
  __IO uint32_t LCKR;
} GPIO_TypeDef_STM; // the daplink style. copied from stm32f103xb.h by Raymond
