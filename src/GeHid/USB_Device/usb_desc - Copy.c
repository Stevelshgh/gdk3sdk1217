...
{
    0x05/*0000 0101*/, 0x01, // USAGE_PAGE (Generic Desktop)
    0x09/*0000 1001*/, 0x00, // USAGE (0)

    0xa1/*1010 0001*/, 0x01, // COLLECTION (Application)
    0x15/*0001 0101*/, 0x00, //     LOGICAL_MINIMUM (0)
    0x25/*0010 0101*/, 0xff, //     LOGICAL_MAXIMUM (255)

    0x19/*0001 1001*/, 0x01, //     USAGE_MINIMUM (1)
    0x29/*0010 1001*/, 0x08, //     USAGE_MAXIMUM (8)
    0x95/*1001 0101*/, DEF_USBD_ENDP2_SIZE/*EP2MaxBuffer*/, //     REPORT_COUNT 
    0x75/*0111 0101*/, 0x08, //     REPORT_SIZE (8)
    0x81/*1000 0001*/, 0x02, //     INPUT (Data,Var,Abs)

    0x19/*0001 1001*/, 0x01, //     USAGE_MINIMUM (1)
    0x29/*0010 1001*/, 0x08, //     USAGE_MAXIMUM (8)
	0x95/*1001 0101*/, DEF_USBD_ENDP2_SIZE/*EP3MaxBuffer*/, //     REPORT_COUNT 
    0x75/*0111 0101*/, 0x08, //     REPORT_SIZE (8)
    0x91/*1001 0001*/, 0x02, //   OUTPUT (Data,Var,Abs)
    0xc0/*1100 0000*/        // END_COLLECTION	  
};
...
//HID_Descriptor 
    ...
    sizeof(HID_DESCRIPTOR),                      // 7:  Total length of Report descriptor L
