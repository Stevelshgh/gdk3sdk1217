...
const char* USB_STANDARD_REQUEST_NAME[] = 
{
  "GET_STATUS", // = 0,
  "CLEAR_FEATURE",
  "RESERVED1",
...
const char* Gd_GetUsbStandardRequestName(STANDARD_REQUESTS r)
{
  if(r >= 0 && r < sizeof(USB_STANDARD_REQUEST_NAME)/sizeof(USB_STANDARD_REQUEST_NAME[0]))
    return USB_STANDARD_REQUEST_NAME[r];
  return "UNKWN";
}
/*********************************************************************
...
uint8_t Setup0_Process(void)
{
  ...
  pInformation->ControlState = SETTING_UP;
	...
	printf("USBSetup: %s[type %d], len %d\n", Gd_GetUsbStandardRequestName(pInformation->USBbRequest),
    pInformation->USBbmRequestType, pInformation->USBwLength);
