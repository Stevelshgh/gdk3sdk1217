...
{
	{(uint8_t*)BeiUSB_StrLangID, USBD_SIZE_STRING_LANGID},
	{(uint8_t*)BeiUSB_StrVendor, USBD_SIZE_STRING_VENDOR},
	{(uint8_t*)BeiUSB_StrProduct,USBD_SIZE_STRING_PRODUCT},
	{(uint8_t*)BeiUSB_StrSerial, USBD_SIZE_STRING_SERIAL}
};
