...
/*******************************************************************************/
/* Header File */
#include "nan_usbd_desc.h"

/*******************************************************************************/
/* Device Descriptor */
const uint8_t NanUsbDescDevDesc[ ] =
{
    0x12,                                                   // bLength
    ...
    (uint8_t)NAN_USB_VID, (uint8_t)( NAN_USB_VID >> 8 ),    // idVendor
    (uint8_t)NAN_USB_PID, (uint8_t)( NAN_USB_PID >> 8 ),    // idProduct
...
/* Language Descriptor */
const uint8_t NanUsbDescLangDesc[ ] =
{
    0x04,
    0x03,
    0x09,
...
const uint8_t NanUsbDescManuName[ ] =
{
	24,    
	0x3,           
...
/* Product Information */
const uint8_t NanUsbDescProdName[ ]  =
{
    42,
    0x3,
    'N',0,'a',0,'n',0,'o',0,' ',0,'K',0,'e',0,'y',0,'b',0,'o',0,'a',0,'r',0,'d',0,' ',0,'M',0,'o',0,'u',0,'r',0,'s',0,'e',0,
};

/* Serial Number Information */
const uint8_t  NanUsbDescSerialNo[ ] =
{
    0x16,
    0x03,
